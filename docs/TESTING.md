...
The test suite contains **26 robust test cases** structured into five major category blocks:
...
- **`test_retrieval_quality_ranks_leave_above_unrelated`**: Verifies that leave-related queries rank leave content above unrelated security or retirement content.
...
- **`test_citation_has_source_and_section`**: Confirms that citation tags map directly back to source documents and section headings.
- **`test_valid_citations`**: Validates that standard grounded answers with correct citation tags pass the citation validation layer.
- **`test_nonexistent_citation`**: Detects and rejects fabricated citation IDs like `[99]`.
- **`test_answer_with_missing_citations`**: Detects and rejects answers containing factual content but missing inline citations.
- **`test_multiple_valid_citations`**: Verifies validation behavior for answers referencing multiple valid citation tags.
...
All 26 test cases passed successfully in a fresh environment:
...
..\tests\test_cerebro.py::TestRetrieval::test_retrieval_quality_ranks_leave_above_unrelated PASSED
...
..\tests\test_cerebro.py::TestCitations::test_build_assigns_sequential_ids PASSED
..\tests\test_cerebro.py::TestCitations::test_context_contains_citation_headers PASSED
..\tests\test_cerebro.py::TestCitations::test_citation_has_source_and_section PASSED
..\tests\test_cerebro.py::TestCitations::test_valid_citations PASSED
..\tests\test_cerebro.py::TestCitations::test_nonexistent_citation PASSED
..\tests\test_cerebro.py::TestCitations::test_answer_with_missing_citations PASSED
..\tests\test_cerebro.py::TestCitations::test_multiple_valid_citations PASSED
..\tests\test_cerebro.py::TestGrounding::test_insufficient_evidence_response PASSED
..\tests\test_cerebro.py::TestGrounding::test_keyword_fallback_includes_sources PASSED
..\tests\test_cerebro.py::TestDocumentIngestion::test_chunk_text_splits_correctly PASSED
..\tests\test_cerebro.py::TestDocumentIngestion::test_chunk_preserves_metadata PASSED
..\tests\test_cerebro.py::TestDocumentIngestion::test_load_txt_file PASSED
..\tests\test_cerebro.py::TestDocumentIngestion::test_empty_directory_returns_no_chunks PASSED
..\tests\test_cerebro.py::TestAPI::test_health_endpoint PASSED
..\tests\test_cerebro.py::TestAPI::test_research_endpoint_returns_answer PASSED
..\tests\test_cerebro.py::TestAPI::test_research_endpoint_insufficient PASSED
..\tests\test_cerebro.py::TestAPI::test_research_rejects_empty_query PASSED
..\tests\test_cerebro.py::TestAPI::test_documents_endpoint PASSED
..\tests\test_cerebro.py::TestAPI::test_stats_endpoint PASSED
